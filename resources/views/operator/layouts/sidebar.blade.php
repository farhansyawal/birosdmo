<aside {{-- PERBAIKAN: Hapus 'my-4' dan 'rounded-2xl' di desktop (xl:) untuk membuat sidebar full height --}} class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 
           block w-full -translate-x-full flex-wrap items-center justify-between 
           overflow-y-auto border-0 bg-white p-0 antialiased 
           shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 
           xl:bg-transparent xl:h-screen xl:rounded-none" {{-- Tambahkan ID untuk referensi di CSS/JS, jika diperlukan
    --}} id="sidenav-main">
    ...
    {{-- Konten Navigasi --}}
    {{-- PERBAIKAN: Hapus max-h-screen dan h-sidenav. Biarkan 'overflow-auto' jika konten memang panjang. --}}
    {{-- Jika masih scroll ganda, ganti 'overflow-auto' menjadi 'overflow-y-hidden'. --}}
    <div class="items-center block w-auto max-h-full overflow-auto grow basis-full">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <div
                        ...
                        {{-- Ikon Data Pengguna (Ganti SVG dengan ikon User jika ada) --}}
